...
const labs = [
  { id: 1, title: "No_Lab_yet", image: "/images/hackthebox-banner.png", solution: "/hackthebox/no_lab_yet" },
  // { id: 2, title: "Legacy", image: "/images/hackthebox-banner.png", solution: "/hackthebox/legacy" },
  

]

export default function HackTheBoxLabs() {
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-mono">
      <header className="bg-gray-800 p-4 sticky top-0 z-10">
        <nav className="container mx-auto flex justify-between items-center">
          ...
          <h1 className="text-2xl font-bold text-green-400">Hack The Box Labs</h1>
        </nav>
      </header>
